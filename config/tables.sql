...
-- --------------------------------------------------------------------------------------------
USE tjg_php_mvc_jokes;


-- --------------------------------------------------------------------------------------------
-- Drop Categories Table and Recreate
-- --------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `tjg_php_mvc_jokes`.`categories`;
CREATE TABLE `tjg_php_mvc_jokes`.`categories`
(
...
-- --------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `tjg_php_mvc_jokes`.`jokes`;
CREATE TABLE `tjg_php_mvc_jokes`.`jokes`
(
    `id`          BIGINT UNSIGNED AUTO_INCREMENT,
    `joke`        TEXT         NOT NULL,
...
-- --------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `tjg_php_mvc_jokes`.`users`;
CREATE TABLE `tjg_php_mvc_jokes`.`users`
(
    `id`            BIGINT UNSIGNED AUTO_INCREMENT,
...
-- Create your own hashed passwords by visiting http://tjg-mvc-jokes.text/auth/password
-- --------------------------------------------------------------------------------------------
INSERT INTO `tjg_php_mvc_jokes`.`users` (`id`, `nickname`, `given_name`, `email`, `user_password`, `created_at`)
